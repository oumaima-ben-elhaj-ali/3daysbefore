<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ConsulterFac.aspx.cs" Inherits="PFE.Factures.ConsulterFac" %>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">Consulter Les Factures</strong>
                            </div>
                            <div class="card-body">
                                <div class="row text-center">
                                    ...
                                    <div class="col-md-3 d-flex align-items-center justify-content-center">
                                        <asp:Label ID="Label1" runat="server" Text="Directeur: " CssClass="form-control-label"></asp:Label>
                                        <asp:DropDownList ID="ddlDirecteur" runat="server" CssClass="form-control"></asp:DropDownList>
                                    </div>
                                    <div class="col-md-3 d-flex align-items-center justify-content-center" >
                                ...
                                <span aria-hidden="true">&times;</span>
                                    ...
                                    <asp:GridView ID="gvFacture" CssClass="table table-striped table-bordered" runat="server" AutoGenerateColumns="false" AllowPaging="true" OnPageIndexChanging = "OnPaging">
                                        <Columns>
                                               ...
                                               <asp:BoundField DataField="ID_DIR" HeaderText ="ID directeur" />
                                               <asp:BoundField DataField="ST_NOMDIR" HeaderText ="Nom directeur" />
                                               <asp:BoundField DataField="NU_VALEUR" HeaderText ="Valeur" />
                                               <asp:HyperLinkField Text="Détails" HeaderText="Détails" ControlStyle-CssClass="btn btn-outline-primary btn-sm" DataNavigateUrlFields="ID_FACT" DataNavigateUrlFormatString="DetailsFac.aspx?ID_FACT={0}"/>
                                        </Columns>
                                    </asp:GridView>
