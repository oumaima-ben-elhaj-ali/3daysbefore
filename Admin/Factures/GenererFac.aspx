<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GenererFac.aspx.cs" Inherits="PFE.Factures.GenererFac" %>
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">                           
                            <li><i class="fa fa-list"></i><a href="../Utilisateurs/ConsulterUser.aspx">Consulter</a></li>
                            <li><i class="fa fa-plus-square"></i><a href="../Utilisateurs/AjouterUser.aspx">Ajouter</a></li>
                        </ul>
                    </li>
                    <li class="menu-item-has-children dropdown">
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">                           
                            <li><i class="fa fa-list"></i><a href="ConsulterFac.aspx">Consulter</a></li>
                            <li><i class="fa fa-plus-square"></i><a href="GenererFac.aspx">Générer</a></li>
                        </ul>
                    </li>
                </ul>
            </div><!-- /.navbar-collapse -->
                ...
                <div class="header-menu">
                    ...
                    <div class="user-area dropdown float-right">
                        ...
                        <div class="user-menu dropdown-menu">
                            <a class="nav-link" href="../Utilisateurs/ProfilUser.aspx"><i class="fa fa-user"></i>Mon Profil</a>
                                ...
                                <div class="page-header float-right">
                                    <div class="page-title">
                                        <ol class="breadcrumb text-right">
                                            ...
                                            <li><a href="ConsulterFac.aspx">Factures</a></li>
                                            <li class="active">Générer</li>
                                        </ol>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">Génération des simulation</strong>
                            </div>
                            <div id="mydiv" runat="server" class="sufee-alert alert with-close alert-success alert-dismissible fade show my-margin-lf-rg">
                                <span class="badge badge-pill badge-success">Info</span><asp:Label ID="info" runat="server" Text="la génération des factures commence le 5 du mois"></asp:Label>
                            ...
                            <br />
                            <div class="text-center">
                                <asp:Button ID="BTNgenerer" runat="server" Text="Générer" CssClass="btn btn-success" OnClick="BTNgenerer_Click" />
                            </div>
                                
                            <div class="card-body">
                                    <asp:GridView ID="gvFactures" CssClass="table table-striped table-bordered" runat="server" AutoGenerateColumns="false" AllowPaging="true" OnPageIndexChanging = "OnPaging">
                                        <Columns>
                                               <asp:BoundField DataField="ID_FACT" HeaderText ="ID facture" />
                                               <asp:BoundField DataField="DT_CREATE" HeaderText ="Date Creation" />
                                               <asp:BoundField DataField="ID_DIR" HeaderText ="nom directeur" />
                                               <asp:BoundField DataField="ST_NOMDIR" HeaderText ="nom directeur" />
                                               <asp:BoundField DataField="NU_VALEUR" HeaderText ="Valeur" />
                                               <asp:HyperLinkField Text="Details" HeaderText="Details" ControlStyle-CssClass="btn btn-outline-primary btn-sm" DataNavigateUrlFields="ID_FACT" DataNavigateUrlFormatString="DetailsFac.aspx?ID_FACT={0}"/>
                                        </Columns>
                                    </asp:GridView>
