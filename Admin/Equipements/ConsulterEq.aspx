<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ConsulterEq.aspx.cs" Inherits="PFE.Equipements.ConsulterEq" %>
<!doctype html>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">Liste des équipements</strong>
                            </div>
                            <div class="card-body">
                              <div class="text-center row">
                                ...
                                <span class="badge badge-pill badge-warning">Info</span> Aucun équipement trouvée!
                                ...
                                <span aria-hidden="true">&times;</span>
                                          ...
                                          <asp:GridView ID="gvEquipement" CssClass="table table-striped table-bordered" runat="server" AutoGenerateColumns="false" AllowPaging="true" OnPageIndexChanging = "OnPaging">
                                              <Columns>
                                               ...
                                               <asp:BoundField DataField="ID_CODIMP" HeaderText ="Catégorie" />
                                               <asp:BoundField DataField="NU_PRIACH" HeaderText ="Prix d'achat" />
                                               <asp:BoundField DataField="NU_PRIACT" HeaderText ="Taux de location" />
                                              <asp:HyperLinkField Text="Mouvements" HeaderText="Mouvements" ControlStyle-CssClass="btn btn-outline-info" DataNavigateUrlFields="ST_CODCOU" DataNavigateUrlFormatString="Mouvement.aspx?ST_CODCOU={0}"/>
                                              <asp:HyperLinkField Text="Modifier" HeaderText="Modification" ControlStyle-CssClass="btn btn-outline-warning" DataNavigateUrlFields="ST_CODCOU" DataNavigateUrlFormatString="ModifierEq.aspx?ST_CODCOU={0}"/>
                                              <asp:HyperLinkField Text="Supprimer" HeaderText="Suppression" ControlStyle-CssClass="btn btn-outline-danger" DataNavigateUrlFields="ST_CODCOU" DataNavigateUrlFormatString="SupprimerEq.aspx?ST_CODCOU={0}"/>
