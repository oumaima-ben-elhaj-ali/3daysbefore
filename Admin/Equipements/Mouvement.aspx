<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Mouvement.aspx.cs" Inherits="PFE.Equipements.Mouvement" %>
...
<body>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">Table des mouvements</strong>
                            </div>
                            <div id="mydiv" class="sufee-alert alert with-close alert-secondary alert-dismissible fade show my-margin-lf-rg">
                                <span class="badge badge-pill badge-warning">Info</span> Aucun déplacement trouvé.. Pour le déplacer
                                <asp:LinkButton ID="mvt_event" runat="server" CssClass="badge badge-pill badge-primary" Text="Cliquer ici" Visible="true" OnClick="GoToDeplacer"/>
                             ...
                             <div class="card-body">
                                <div>
                                    ...
                                    <asp:GridView ID="gvMouvement" CssClass="table table-striped table-bordered" runat="server" AutoGenerateColumns="false" AllowPaging="true" OnPageIndexChanging = "OnPaging">
                                        <Columns>
                                               <asp:BoundField DataField="ID_MVT" HeaderText ="ID mouvement" />
                                               <asp:BoundField DataField="ST_CODEEQ" HeaderText ="Code équipement" />
                                               <asp:BoundField DataField="ST_DESCH" HeaderText ="Chantier Destination" />
                                               <asp:BoundField DataField="DT_MVT" HeaderText ="Date du mouvement " />
                                               <asp:BoundField DataField="NU_CIN" HeaderText ="CIN charge " />
                                               <asp:BoundField DataField="ST_TYPEMVT" HeaderText ="Type du mouvement" />
                                        </Columns>
                                    </asp:GridView>
                                </div>
                             </div>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            console.log(p);
            if (p > 0) {
                $("#mydiv").addClass("customer_custom1");
            }
      } );
  </script>
    </form>
