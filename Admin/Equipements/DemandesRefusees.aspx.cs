...
{
    public partial class DemandesRefusees : System.Web.UI.Page
    {
        ...
        private void SearchDemandes()
        {
            ...
            using (SqlConnection con = new SqlConnection(connetionString))
            {
                ...
                {
                    string sql = "SELECT ID_DEMANDE, ID_CODUTI, ST_CODEQ, ST_DESCH, CONVERT(varchar, DT_CREATE, 1) AS DT_CREATE, CONVERT(varchar, DT_DEBUT, 1) AS DT_DEBUT, CONVERT(varchar, DT_FIN, 1) AS DT_FIN FROM EXTDEMLOC WHERE ST_STATUS LIKE 'REFUSED' ORDER BY DT_CREATE DESC ";
