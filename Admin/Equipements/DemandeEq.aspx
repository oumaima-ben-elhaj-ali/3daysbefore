<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DemandeEq.aspx.cs" Inherits="PFE.Admin.Equipements.DemandeEq" %>
<!doctype html>
                        ...
                        <div class="page-header float-right">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    ...
                                    <li class="active">Demandes de location</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">Les demandes de location</strong>
                            </div>
                            <br />
                            <div class="text-right" style="margin-right:18px;">
                                <asp:Button ID="demAccepted" Text="Demandes acceptées" runat="server" CssClass="btn btn-info" OnClick="demAccepted_Click" />
                                <asp:Button ID="demRefused" Text="Demandes réfusées" runat="server" CssClass="btn btn-warning" OnClick="demRefused_Click" />
                            </div>
                            <div class="card-body">
                                <div id="mydiv" runat="server" class="sufee-alert alert with-close alert-secondary alert-dismissible fade show my-margin-lf-rg">
                                <span class="badge badge-pill badge-warning">Info</span> Aucune demande reçue
                                ...
                                <span aria-hidden="true">&times;</span>
                                          ...
                                          <asp:GridView ID="gvEquipement" CssClass="table table-striped table-bordered" runat="server" AutoGenerateColumns="false" AllowPaging="true" OnPageIndexChanging = "OnPaging">
                                              <Columns>
                                              <asp:BoundField DataField="DT_CREATE" HeaderText ="Dt.demande" />
                                              <asp:BoundField DataField="ID_CODUTI" HeaderText ="Utilisateur" />
                                              <asp:BoundField DataField="ST_CODEQ" HeaderText ="Code équipement" />
                                              <asp:BoundField DataField="ST_DESCH" HeaderText ="Chantier" />
                                              <asp:BoundField DataField="DT_DEBUT" HeaderText ="Dt.début" />
                                              <asp:BoundField DataField="DT_FIN" HeaderText ="Dt.fin" />
                                              <asp:HyperLinkField Text="Accepter" HeaderText="Action" ControlStyle-CssClass="btn btn-outline-success" DataNavigateUrlFields="ID_DEMANDE" DataNavigateUrlFormatString="DeplacerEq.aspx?ID_DEMANDE={0}"/>
                                              <asp:HyperLinkField Text="Refuser" HeaderText="Action" ControlStyle-CssClass="btn btn-outline-danger" DataNavigateUrlFields="ID_DEMANDE" DataNavigateUrlFormatString="RefuserEq.aspx?ID_DEMANDE={0}"/>
                                              </Columns>
                                           </asp:GridView>
                                    </div>
                            </div>
