<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AjouterUti.aspx.cs" Inherits="PFE.Utilisateurs.AjouterUser" %>
<!doctype html>
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">                           
                            <li><i class="fa fa-list"></i><a href="ConsulterUti.aspx">Consulter</a></li>
                            <li><i class="fa fa-plus-square"></i><a href="AjouterUti.aspx">Ajouter</a></li>
                        </ul>
                    </li>
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">                           
                            ...
                            <li><i class="fa fa-mail-forward"></i><a href="../Equipements/DeplacerEq.aspx">Deplacer</a></li>
                        ...
                        <div class="page-header float-right">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    ...
                                    <li><a href="ConsulterUti.aspx">Utilisateurs</a></li>
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            ...
                            <div class="card-body card-block">
                                <div id="mydiv" runat="server" class="row">
                                        <div class="col-lg-12">
                                ...
                                <div class="row form-group">
                                     <div class="col-lg-6">
                                         <div class="row">
                                             ...
                                             <div class="col-lg-6"><asp:TextBox ID="idUser" runat="server" value="user" CssClass="form-control"></asp:TextBox></div>
                                         </div>
                                     </div>
                                    <div class="col-lg-6">
                                         <div class="row">
                                             <div class="col-lg-4"><asp:Label ID="Label7" runat="server" CssClass="form-control-label">CIN:</asp:Label></div>
                                             <div class="col-lg-6"><asp:TextBox ID="codeInt" runat="server" value="user" CssClass="form-control" MaxLength="8"></asp:TextBox></div>
                                        </div>
                                    </div>
                                </div>
                                <hr />
                                <div class="row form-group">
                                     <div class="col-lg-6">
                                         <div class="row">
                                             ...
                                             <div class="col-lg-6"><asp:TextBox ID="nomUser" runat="server" CssClass="form-control"></asp:TextBox></div><br />
                                         </div>
                                     </div>
                                    <div class="col-lg-6">
                                         <div class="row">
                                             <div class="col-lg-4"><asp:Label ID="Label5" runat="server" CssClass="form-control-label">Prénom:</asp:Label></div>
                                             <div class="col-lg-6"><asp:TextBox ID="prenomUser" runat="server" CssClass="form-control"></asp:TextBox></div>
                                        </div>
                                    </div>
                                </div>
                                <hr />
                                <div class="row form-group">
                                     <div class="col-lg-6">
                                         <div class="row">
                                             ...
                                             <div class="col-lg-6"><asp:TextBox ID="mailUser" runat="server" CssClass="form-control"></asp:TextBox></div><br />
                                         </div>
                                     </div>
                                    <div class="col-lg-6">
                                         <div class="row">
                                ...
                                <div class="row form-group">
                                     <div class="col-lg-6">
                                         <div class="row">
                                             ...
                                             <div class="col-lg-6"><asp:TextBox ID="mdpUser" runat="server" value="user" CssClass="form-control"></asp:TextBox></div><br />
                                         </div>
                                     </div>
                                    <div class="col-lg-6">
                                         <div class="row form-group">
                                             <div class="col-lg-4"><asp:Label ID="select" CssClass=" form-control-label" runat="server">Ajouter comme étant:</asp:Label></div>
                                             <div class="col-lg-6"><asp:DropDownList ID="desPro"  CssClass="form-control" runat="server" AppendDataBoundItems="True" AutoPostBack="true" OnSelectedIndexChanged="desPro_SelectedIndexChanged"/></div>
                                        </div>
                                    </div>
                                </div>
                                <div id="chantierInfo" runat="server">
                                    <div class="row form-group">
                                        <div class="col-lg-6"></div>
                                        <div class="col-lg-6">
                                            <div class="row form-group">
                                                <div class="col-lg-4"><asp:Label runat="server" CssClass=" form-control-label">Chantiers correspendants :</asp:Label></div>
                                                <div class="col-lg-6"><asp:TextBox ID="chantier" runat="server" value="Chantier..." CssClass="form-control"></asp:TextBox></div><br />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col-lg-6"></div>
                                            <div class="col-lg-6 text-center">
                                                <asp:Button ID="confirmCH" runat="server" Text="Confirmer le chantier" OnClick="ConfirmCH_Click" CssClass="btn btn-outline-primary btn-sm"/>
                                            </div>
                                    </div>
                                     <div class="row form-group">
                                        <div class="col-lg-6"></div>
                                         <div class="col-lg-6 text-center">
                                            <div id="CHaddSuccess" runat="server" class="sufee-alert alert with-close alert-success alert-dismissible fade show">
                                                <span class="badge badge-pill badge-success">Info</span><asp:Label ID="Label8" Text="Chantier confirmé! Vous pouvez ajouter un autre chantier." runat="server"></asp:Label> 
                                                <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                                <span aria-hidden="true">&times;</span>
                                                </button>
                                            </div>
                                ...
                                <div class=" card-footer marginLeft text-right">
                                          <asp:Button ID="BTNajouter" runat="server" BorderStyle="None" OnClick="BTNajouter_Click" Text="Ajouter" CssClass="btn btn-success" />
