<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ConsulterUti.aspx.cs" Inherits="PFE.Utilisateurs.ConsulterUser" %>
<!doctype html>
                  ...
                  <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">Table Utilisateurs</strong>
                            </div>
                            <div class="card-body">
                                         <div class="text-center row">
                                                <asp:TextBox ID="txtSearch" runat="server" OnTextChanged="Search" AutoPostBack="true" CssClass="form-control widthControl"></asp:TextBox>
                                                <asp:Button ID="rechercher" runat="server" Text="Rechercher" OnClick="Search" CssClass="btn btn-success"/>
                                         </div>
                                         
                                         <hr />
                                          <asp:GridView ID="gvUser" CssClass="table table-striped table-bordered" runat="server" AutoGenerateColumns="false" AllowPaging="true" OnPageIndexChanging = "OnPaging">
                                              <Columns>
                                               <asp:BoundField DataField="ID_CODUTI" HeaderText ="ID utilisateur" />
                                               <asp:BoundField DataField="ST_NOM" HeaderText ="Nom " />
                                               <asp:BoundField DataField="ST_PRE" HeaderText ="Prénom" />
                                               <asp:BoundField DataField="ST_MOTPAS" HeaderText ="Mot de passe" />
                                               <asp:BoundField DataField="ST_MAIL" HeaderText ="Email" />
                                               <asp:HyperLinkField Text="Modifier" HeaderText="Modification" ControlStyle-CssClass="btn btn-outline-warning" DataNavigateUrlFields="ID_CODUTI" DataNavigateUrlFormatString="ModifierUti.aspx?ID_CODUTI={0}"/>
                                               <asp:HyperLinkField Text="Supprimer" HeaderText="Suppression" ControlStyle-CssClass="btn btn-outline-danger" DataNavigateUrlFields="ID_CODUTI" DataNavigateUrlFormatString="SupprimerUti.aspx?ID_CODUTI={0}"/>
