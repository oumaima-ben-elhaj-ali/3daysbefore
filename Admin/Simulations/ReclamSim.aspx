<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReclamSim.aspx.cs" Inherits="PFE.Simulations.ReclamSim" %>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">Liste des réclamations</strong>
                            </div>
                            <div class="card-body">
                                <div id="mydiv" runat="server" class="sufee-alert alert with-close alert-secondary alert-dismissible fade show my-margin-lf-rg">
                                <span class="badge badge-pill badge-warning">Info</span> Aucune réclamation Pour le moment
                                <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                                </button>
                                    
                                </div>
                                    <asp:GridView ID="gvReclamations" CssClass="table table-striped table-bordered" runat="server" AutoGenerateColumns="false" AllowPaging="true" OnPageIndexChanging = "OnPaging">
                                        <Columns>
                                               <asp:BoundField DataField="ID_CODUTI" HeaderText ="Directeur" />
                                               <asp:BoundField DataField="ID_SIM" HeaderText ="ID Simulation" />
                                               <asp:BoundField DataField="DT_RECLAM" HeaderText ="Date" />
                                               <asp:BoundField DataField="ST_RECLAM" HeaderText ="Réclamation" />
                                               <asp:HyperLinkField Text="Corriger et valider" HeaderText="Validation" ControlStyle-CssClass="btn btn-outline-primary btn-sm" DataNavigateUrlFields="ID_SIM" DataNavigateUrlFormatString="ValiderSim.aspx?ID_SIM={0}"/>
                                        </Columns>
                                    </asp:GridView>
                            </div>
                        </div>
