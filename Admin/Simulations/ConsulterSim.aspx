<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ConsulterSim.aspx.cs" Inherits="PFE.Simulations.ConsulterSim" %>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="row text-center">
                                    ...
                                    <div class="col-md-3 d-flex align-items-center justify-content-center">
                                        <asp:Label ID="Label1" runat="server" Text="Chantier: " CssClass="form-control-label"></asp:Label>
                                        <asp:DropDownList ID="ddlChantier" runat="server" CssClass="form-control widthControl"></asp:DropDownList>
                                    </div>
                                    <div class="col-md-3 d-flex align-items-center justify-content-center" >
                                ...
                                <span class="badge badge-pill badge-warning">Info</span> Aucune simulation trouvée! Vérifier les données que vous avez entré
                                ...
                                <span aria-hidden="true">&times;</span>
                                    ...
                                    <asp:GridView ID="gvSimulation" CssClass="table table-striped table-bordered" runat="server" AutoGenerateColumns="false" AllowPaging="true" OnPageIndexChanging = "OnPaging">
                                        <Columns>
                                               ...
                                               <asp:HyperLinkField Text="Détails" HeaderText="Details" ControlStyle-CssClass="btn btn-outline-primary btn-sm" DataNavigateUrlFields="ID_SIM" DataNavigateUrlFormatString="DetailsSim.aspx?ID_SIM={0}"/>
                                        </Columns>
                                    </asp:GridView>
