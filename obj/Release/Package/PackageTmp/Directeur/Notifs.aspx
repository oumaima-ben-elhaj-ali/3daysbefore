<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Notifs.aspx.cs" Inherits="PFE.Directeur.Notifs" %>
                                     ...
                                     <div>
                                         <hr />
                                          <asp:GridView ID="gvNotifs" CssClass="table table-striped table-bordered" runat="server" AutoGenerateColumns="false" AllowPaging="true" OnPageIndexChanging = "OnPaging">
                                              <Columns>
                                               <asp:BoundField DataField="ST_OBSTRA" HeaderText ="Notification" />
                                               <asp:BoundField DataField="DT_CREATE" HeaderText ="Date" />
