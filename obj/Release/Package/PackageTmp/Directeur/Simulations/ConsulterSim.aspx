<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ConsulterSim.aspx.cs" Inherits="PFE.Directeur.Simulations.ConsulterSim" %>
<!doctype html>
                    ...
                    <div class="header-left">
                        ...
                        <div class="dropdown for-message">
                            ...
                            <div class="dropdown-menu" aria-labelledby="message">
                                <p class="red text-center notiftitle">Notification</p>
                                ...
                                <span aria-hidden="true">&times;</span>
                                    ...
                                    <asp:GridView ID="gvSimulation" CssClass="table table-striped table-bordered" runat="server" AutoGenerateColumns="false" AllowPaging="true" OnPageIndexChanging = "OnPaging">
                                        <Columns>
                                               ...
                                               <asp:HyperLinkField Text="Details" HeaderText="Details" ControlStyle-CssClass="btn btn-outline-primary btn-sm" DataNavigateUrlFields="ID_SIM" DataNavigateUrlFormatString="DetailsSim.aspx?ID_SIM={0}"/>
                                        </Columns>
                                    </asp:GridView>
