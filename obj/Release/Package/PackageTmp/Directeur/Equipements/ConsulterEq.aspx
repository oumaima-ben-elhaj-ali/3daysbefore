<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ConsulterEq.aspx.cs" Inherits="PFE.Directeur.Equipements.ConsulterEq" %>
<!doctype html>
                                ...
                                <span aria-hidden="true">&times;</span>
                                          ...
                                          <asp:GridView ID="gvEquipement" CssClass="table table-striped table-bordered" runat="server" AutoGenerateColumns="false" AllowPaging="true" OnPageIndexChanging = "OnPaging">
                                              <Columns>
                                               ...
                                               <asp:BoundField DataField="DT_ACH" HeaderText ="Date fabrication" />
