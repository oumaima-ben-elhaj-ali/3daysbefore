<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ModifierUti.aspx.cs" Inherits="PFE.Utilisateurs.ModifierUser" %>
<!doctype html>
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-lg-6">
                                         <div class="row">
                                             ...
                                             <div class="col-lg-6"><asp:TextBox ID="codeInt" MaxLength="8" runat="server" value="user" CssClass="form-control"></asp:TextBox></div>
                                        </div>
                                    </div>
                                </div>
                                <hr />
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-lg-6">
                                         <div class="row form-group">
                                             ...
                                             <div class="col-lg-6"><asp:DropDownList ID="desPro"  CssClass="form-control" runat="server" AppendDataBoundItems="True" AutoPostBack="true"/></div>
                                        </div>
                                    </div>
                                </div>
                                    <div class="card-footer text-right">
                                        <asp:Button ID="BTNvaliderModif" runat="server" BorderStyle="None" Text="Valider les modification" CssClass="btn btn-success" OnClick="BTNvaliderModif_Click" />
