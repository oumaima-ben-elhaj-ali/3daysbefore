<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DetailsFac.aspx.cs" Inherits="PFE.Factures.DetailsFac" %>
                  ...
                  <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">Détails de la facture du directeur <asp:Label ID="nom" runat="server"></asp:Label></strong>
                            </div>
                            <div class="card-body">
                                <div class="float-right">
                                <asp:Label CssClass="btn btn-info m-l-10 m-b-10" ID="factTotal" runat="server"></asp:Label>
                                </div>
<asp:Repeater ID="ParentRepeater"  runat="server">
	...
	<ItemTemplate>
		<tr>
		<th>Désignation chantier: &nbsp;<b><%# DataBinder.Eval(Container.DataItem, "CH_ENTETE") %></b></th>
        <td colspan="2">Total par chantier: &nbsp; <%# DataBinder.Eval(Container.DataItem, "SimTotal") %> </td>
		</tr>
		<tr>
		<th >Code</th>
		<th>Désignation</th>
	...
	<asp:Repeater ID="childRepeater" runat="server"  DataSource='<%# ((System.Data.DataRowView)Container.DataItem).Row.GetChildRows("myrelation") %>'>
		<ItemTemplate>
			<tr>
			<td>
			<asp:Label ID="lblEmpId" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "[\"ST_CODEQ\"]")%>' />
			</td>
			<td><%# DataBinder.Eval(Container.DataItem, "[\"ST_DESEQ\"]")%></td>
            <td><%# DataBinder.Eval(Container.DataItem, "[\"DT_ENTREE\"]")%></td>
			<td><%# DataBinder.Eval(Container.DataItem, "[\"DT_SORTIE\"]")%></td>
            <td><%# DataBinder.Eval(Container.DataItem, "[\"NU_NBJRS\"]")%></td>
			<td><%# DataBinder.Eval(Container.DataItem, "[\"NU_TAUXLOC\"]")%></td>
            <td><%# DataBinder.Eval(Container.DataItem, "[\"NU_VALEUR\"]")%></td>
			</tr>
		</ItemTemplate>
		<FooterTemplate>
			<tr>
			<td colspan="7" style="height: 20px; background-color:transparent;"></td>
			</tr>
		</FooterTemplate>
	</asp:Repeater>
	</ItemTemplate>
