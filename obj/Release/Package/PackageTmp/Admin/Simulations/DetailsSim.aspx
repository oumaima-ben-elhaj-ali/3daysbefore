<%@ Page Language="C#" AutoEventWireup="true" EnableEventValidation="false" CodeBehind="DetailsSim.aspx.cs" Inherits="PFE.Simulations.DetailsSim" %>
<!doctype html>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <asp:Label ID="SimTotal" runat="server" CssClass="btn btn-info m-l-10 m-b-10"></asp:Label>
                                </div>
                                <br />
                                <br />
                                  <asp:GridView ID="gvSimDetails" runat="server" AutoGenerateColumns="false" ShowFooter="true" DataKeyNames="ID_DEP"
                                  ...
                                  OnRowUpdating="gvSimDetails_RowUpdating" OnRowDeleting="gvSimDetails_RowDeleting" CssClass="table table-striped table-bordered" Style="box-sizing:border-box; text-align: center;">
                                    <Columns >
                                            ...
                                            <asp:TemplateField>
                                                ...
                                                <EditItemTemplate>
                                                    <asp:ImageButton ImageUrl="~/images/save.png" runat="server" CommandName="Update" ToolTip="Mettre à jour" Width="20px" Height="20px"/>
