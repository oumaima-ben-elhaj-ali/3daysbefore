<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GenererSim.aspx.cs" Inherits="PFE.Simulations.GenererSim" %>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">Génération des simulations</strong>
                            </div>
                            <div ID="mydiv" runat="server" class="sufee-alert alert with-close alert-success alert-dismissible fade show my-margin-lf-rg">
                                <span class="badge badge-pill badge-success">Info</span> la génération des simulations commence le 1er du mois prochain.. 
                            ...
                            <div class="card-body">
                                    <asp:TextBox ID="div_ctrl" CssClass="customer_custom1" runat="server"/>
                                    <asp:GridView ID="gvSimulation" CssClass="table table-striped table-bordered" runat="server" AutoGenerateColumns="false" AllowPaging="true" OnPageIndexChanging = "OnPaging">
                                        <Columns>
                                               <asp:BoundField DataField="ID_SIM" HeaderText ="ID simulation" />
                                               <asp:BoundField DataField="DT_CREATE" HeaderText ="Date Création" />
                                               <asp:BoundField DataField="ST_DESCH" HeaderText ="Chantier Correspendant" />
                                               <asp:BoundField DataField="NU_VALEUR" HeaderText ="Valeur" />
                                               <asp:HyperLinkField Text="Détails" HeaderText="Détails" ControlStyle-CssClass="btn btn-outline-primary btn-sm" DataNavigateUrlFields="ID_SIM" DataNavigateUrlFormatString="DetailsSim.aspx?ID_SIM={0}"/>
                                        </Columns>
                                    </asp:GridView>
                             </div>
                        </div>
