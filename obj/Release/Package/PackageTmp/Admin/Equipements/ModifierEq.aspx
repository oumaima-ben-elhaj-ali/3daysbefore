<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ModifierEq.aspx.cs" Inherits="PFE.Equipements.ModifierEq" %>
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <strong>Modifier équipement</strong>
                            </div>
                            <div class="card-body card-block">
                                <div class="row">
                                     <div class="col-lg-6">
                                         <div class="row">
                                             ...
                                             <div class="col-lg-7"><asp:TextBox ReadOnly="true" ID="idEQ" TextMode="Number" Text="123456789" runat="server" CssClass="form-control" MaxLength="9"></asp:TextBox></div>
                                         </div>
                                     </div>
                                    <div class="col-lg-6">
                                         <div class="row">
                                             <div class="col-lg-5"><asp:Label ID="Label0" runat="server" CssClass="form-control-label">Code d'équipement:</asp:Label></div>
                                             <div class="col-lg-7"><asp:TextBox ReadOnly="true" ID="CodCouEQ" runat="server" CssClass="form-control" MaxLength="14"></asp:TextBox></div>
                                        </div>
                                    </div>
                                </div>
                                <hr />
                                <div class="row">
                                     <div class="col-lg-6">
                                         <div class="row">
                                            ...
                                            <div class="col-lg-7"><asp:TextBox ID="Categorie" runat="server" CssClass="form-control"></asp:TextBox></div>
                                         </div>
                                     </div>
                                    <div class="col-lg-6">
                                         <div class="row">
                                            <div class="col-lg-5"><asp:Label ID="Label3" runat="server" CssClass="form-control-label">Désignation:</asp:Label></div>
                                            <div class="col-lg-7"> <asp:TextBox ID="DesEQ" runat="server" CssClass="form-control"></asp:TextBox></div>
                                        </div>
                                    </div>
                                </div>
                                <hr />
                                <div class="row">
                                    <div class="col-lg-6">
                                         <div class="row">
                                            ...
                                            <div class="col-lg-7"><asp:TextBox ID="EmpEQ" runat="server" CssClass="form-control" ReadOnly="true"></asp:TextBox></div>
                                         </div>
                                        <div class="col-lg-5"><asp:Button ID="BTNdeplacer" runat="server" BorderStyle="None"  Text="-------------------------------------Pour deplacer cet equipement.. Cliquer ici!" class="btn btn-link btn-sm" OnClick="BTNdeplacer_Click"/></div>
                                    </div>
                                     <div class="col-lg-6">
                                         <div class="row">
                                            <div class="col-lg-5"><asp:Label ID="Label7" runat="server" CssClass="form-control-label">Code magasin:</asp:Label></div>
                                            <div class="col-lg-7"> <asp:TextBox ID="codeMag" runat="server" CssClass="form-control"></asp:TextBox></div>
                                        </div>
                                     </div>
                                </div>
                                <hr />
                                <div class="row">
                                     <div class="col-lg-6">
                                         <div class="row">
                                            ...
                                            <div class="col-lg-7"> <asp:TextBox ID="fournisseur" runat="server" CssClass="form-control"></asp:TextBox></div>
                                        </div>
                                     </div>
                                     <div class="col-lg-6">
                                         <div class="row">
                                ...
                                <div class="row">
                                     <div class="col-lg-6">
                                         <div class="row">
                                            ...
                                            <div class="col-lg-7"><asp:TextBox ID="PrixEQ" runat="server" CssClass="form-control"></asp:TextBox></div>
                                        </div>
                                     </div>
                                     <div class="col-lg-6">
                                         <div class="row">
                                            <div class="col-lg-5"><asp:Label ID="Label2" runat="server" CssClass="form-control-label">Taux de loacation:</asp:Label></div>
                                            <div class="col-lg-7"><asp:TextBox ID="TauxLoc" runat="server" CssClass="form-control"></asp:TextBox></div>
                                         </div>
                                     </div>
                                </div>
                                <hr />
                                <div class="row">
                                     <div class="col-lg-6">
                                         <div class="row">
                                            <div class="col-lg-5"><asp:Label ID="Label10" runat="server" CssClass="form-control-label">Num ORD:</asp:Label></div>
                                            <div class="col-lg-7"><asp:TextBox ID="numOrd" runat="server" TextMode="number" CssClass="form-control"></asp:TextBox></div>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                         <div class="row">
                                            <div class="col-lg-5"><asp:Label ID="Label11" runat="server" CssClass="form-control-label">Niveau:</asp:Label></div>
                                            <div class="col-lg-7"><asp:TextBox ID="numNiv" runat="server" TextMode="number" CssClass="form-control"></asp:TextBox></div>
                                         </div>
                                    </div>
                                </div>
                                <hr />
                                <div class="row">
                                     ...
                                     <div class="col-lg-6">
                                         <div class="row">
                                            ...
                                            <div class="col-lg-7"><asp:TextBox ID="EQobs" runat="server" CssClass="form-control"></asp:TextBox></div>
                                        </div>
                                     </div>
                                </div>
                                <hr />
                                     ...
                                     <div class="col-lg-6">
                                         <div class="row">
                                             ...
                                             <div class="col-sm-9 text-right">
                                                <asp:Button ID="BTNvaliderModif" runat="server" BorderStyle="None" Text="Valider les modifications" class="btn btn-success" OnClick="BTNvaliderModif_Click" />
