<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DemandesAcceptees.aspx.cs" Inherits="PFE.Admin.Equipements.DemandesAcceptees" %>
<!doctype html>
                        ...
                        <div class="page-header float-right">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    ...
                                    <li class="DemandesAcceptees.aspx">Demandes de location acceptées</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">Les demandes de location acceptées</strong>
                            </div>
                            <div class="card-body">
                                <div id="mydiv" runat="server" class="sufee-alert alert with-close alert-secondary alert-dismissible fade show my-margin-lf-rg">
                                <span class="badge badge-pill badge-warning">Info</span> Aucune demande trouvée
