<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DemandesRefusees.aspx.cs" Inherits="PFE.Admin.Equipements.DemandesRefusees" %>
<!doctype html>
                        ...
                        <div class="page-header float-right">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    ...
                                    <li class="DemandesRefusees.aspx">Demandes de location réfusées</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">Les demandes de location réfusées</strong>
                            </div>
                            <div class="card-body">
