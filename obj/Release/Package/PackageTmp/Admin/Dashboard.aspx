<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Dashboard.aspx.cs" Inherits="PFE.Dashboard" %>
<!doctype html>
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">                           
                            ...
                            <li><i class="fa fa-plus-square"></i><a href="Simulations/GenererSim.aspx">Generer</a></li>
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">                           
                            ...
                            <li><i class="fa fa-plus-square"></i><a href="Factures/GenererFac.aspx">Generer</a></li>
                        </ul>
                    </li>
                </ul>
            </div><!-- /.navbar-collapse -->
        ...
        <div class="content">
            ...
            <div class="animated fadeIn">
                ...
                <div class="row text-center">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="stat-widget-one">
                                    <div class="stat-icon dib"><i class="ti-location-arrow text-warning border-warning"></i></div>
                                    <div class="stat-content dib">
                                        <div class="stat-text">Déplacements mensuels</div>
                                        <div class="stat-digit"><asp:Label ID="countDep" runat="server"></asp:Label></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="card">
                            <div class="card-body">
                                <div class="stat-widget-one">
                                    <div class="stat-icon dib"><i class="ti-clipboard " style="color:#C71585; "></i></div><br />
                                    <div class="stat-content dib">
                                        <div class="stat-text">simulations mensuelles</div>
                                        <div class="stat-digit"><asp:Label ID="nbSim" runat="server"></asp:Label></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="card">
                            <div class="card-body">
                                <div class="stat-widget-one">
                                    <div class="stat-icon dib"><i class="ti-check-box text-primary border-primary"></i></div><br />
                                    <div class="stat-content dib">
                                        <div class="stat-text">factures mensuelles</div>
                                        <div class="stat-digit"><asp:Label ID="nbFactures" runat="server"></asp:Label></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="stat-widget-one">
                                    ...
                                    <div class="stat-content dib">
                                        <div class="stat-text"> Revenues mensuels</div>
                                        <div class="stat-digit"><asp:Label ID="countSim" runat="server"></asp:Label> TND</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="row text-center">
                    <div class="col-lg-3 col-md-6">
                        <div class="card">
                            <div class="card-body">
                                <div class="stat-widget-one">
                                    <div class="stat-icon dib"><i class="ti-truck text-info border-info "></i></div>
                                    <div class="stat-content dib">
                                        <div class="stat-text">Nombre des équipements </div>
                                        <div class="stat-digit"><asp:Label ID="countEq" runat="server"></asp:Label></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="card">
                            <div class="card-body">
                                <div class="stat-widget-one">
                                    <div class="stat-icon dib"><i class="ti-receipt text-danger border-danger"></i></div><br />
                                    <div class="stat-content dib">
                                        <div class="stat-text"> Demandes non traitées </div>
                                        <div class="stat-digit"><asp:Label ID="demandes" runat="server"></asp:Label></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="card">
                            <div class="card-body">
                                <div class="stat-widget-one">
                                    <div class="stat-icon dib"><i class="ti-user" style="color:#9ACD32;"></i></div>
                                    <div class="stat-content dib">
                                        <div class="stat-text">Nombre des utilisateurs</div>
                                        <div class="stat-digit"><asp:Label ID="countUser" runat="server"></asp:Label></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="stat-widget-one">
                                    ...
                                    <div class="stat-content dib">
                                        <div class="stat-text">Réclamations non traitées</div>
                                        <div class="stat-digit"><asp:Label ID="reclamations" runat="server"></asp:Label></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="text-center seeMore">
                        ...
                        Designed by Ben Elhaj Ali Oumaima
                </div>
                <!-- /Widgets -->
                <!--  Traffic  -->
