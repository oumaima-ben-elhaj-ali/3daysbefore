<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ModifProfil.aspx.cs" Inherits="PFE.Directeur.Utilisateurs.ModifProfil" %>
<!doctype html>
                        ...
                        <div class="page-header float-right">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    ...
                                    <li><a href="ProfilUti.aspx">Profil</a></li>
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-lg-6">
                                         <div class="row">
                                             ...
                                             <div class="col-lg-6"><asp:TextBox ID="codeInt" runat="server" value="user" CssClass="form-control"></asp:TextBox></div>
                                        </div>
                                    </div>
                                </div>
                                <hr />
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-lg-6">
                                         <div class="row form-group">
                                             ...
                                             <div class="col-lg-6"><asp:TextBox ID="desPro"  CssClass="form-control" runat="server" ReadOnly="true"/></div>
                                        </div>
                                    </div>
                                </div>
