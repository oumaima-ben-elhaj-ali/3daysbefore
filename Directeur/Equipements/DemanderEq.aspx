<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DemanderEq.aspx.cs" Inherits="PFE.Directeur.Equipements.DemanderEq" %>
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">                           
                            ...
                            <li><i class="fa fa-location-arrow"></i><a href="DeplacementEq.aspx">Suivre les locations</a></li>
                        ...
                        <div class="page-header float-right">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    ...
                                    <li class="active">Demander une location</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="content">
                        <div class="animated fadeIn">
                                ...
                                <div class="col-lg-6 col-md-6">
                                    <div class="card">
                                        <div class="card-header">
                                            <strong>Demande de location d'un équipement</strong>
                                        </div>
                                        <div class="card-body card-block">

                                            <div class="row form-group">
                                                <div class="col col-md-4">
                                                    <asp:Label ID="code" runat="server" CssClass="pb-4 display-5">Code équipement:</asp:Label>
                                                </div>
                                                <div class="col-12 col-md-6">
                                                    <asp:TextBox ID="CodcouEQ" runat="server" CssClass="form-control"></asp:TextBox>
                                                </div>
                                            </div>
                                            <div class="row form-group">
                                                <div class="col col-md-4">
                                                    <asp:Label ID="Label3" runat="server" CssClass="pb-4 display-5">Chantier:</asp:Label>
                                                </div>
                                                <div class="col-12 col-md-6">
                                                    <asp:TextBox ID="chantier" runat="server" CssClass="form-control"></asp:TextBox>
                                                </div>
                                            </div>
                                            <div class="row form-group">
                                                <div class="col col-md-4">
                                                    <asp:Label ID="Label1" runat="server" CssClass="form-control-label">Date début de location:</asp:Label>
                                                </div>
                                                <div class="col-12 col-md-6">
                                                    <asp:TextBox ID="dtDebut" runat="server" CssClass="form-control"></asp:TextBox>
                                                </div>
                                            </div>
                                            <div class="row form-group">
                                                <div class="col col-md-4">
                                                    <asp:Label ID="Label2" runat="server" CssClass="form-control-label">Date fin de location:</asp:Label>
                                                </div>
                                                <div class="col-12 col-md-6">
                                                    <asp:TextBox ID="dtFin" runat="server" CssClass="form-control"></asp:TextBox>
                                                </div>
                                            </div>
                                            ...
                                            <div id="alert" runat="server" class="sufee-alert alert with-close alert-danger alert-dismissible fade show">
                            ...
                            <div class="col-lg-6 col-md-6">
                                    <div class="card">
                                        <div class="card-header">
                                            <strong>Vos demande qui sont pas encore traitées</strong>
                                        </div>
                                        <div class="card-body card-block">
                                            <div id="mydiv" runat="server" class="sufee-alert alert with-close alert-secondary alert-dismissible fade show my-margin-lf-rg">
                                            <span class="badge badge-pill badge-warning">Info</span> Aucune demande est non encore traitée!
                                            <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                            <span aria-hidden="true">&times;</span>
                                            </button>
                                            </div>
                                            <asp:GridView ID="gvDemandes" CssClass="table table-striped table-bordered" runat="server" AutoGenerateColumns="false" AllowPaging="true" OnPageIndexChanging = "OnPaging">
                                        <Columns>
                                               <asp:BoundField DataField="ID_DEMANDE" HeaderText ="ID" Visible="false" />
                                               <asp:BoundField DataField="ST_CODEQ" HeaderText ="Equipement" />
                                               <asp:BoundField DataField="ST_DESCH" HeaderText ="Chantier " />
                                               <asp:BoundField DataField="date" HeaderText ="Date de location" />
                                               <asp:HyperLinkField Text="Annuler" HeaderText="Annuler la demande" ControlStyle-CssClass="btn btn-outline-danger" DataNavigateUrlFields="ID_DEMANDE" DataNavigateUrlFormatString="DemanderEq.aspx?ID_DEMANDE={0}"/>
                                        </Columns>
                                    </asp:GridView>
                                        </div>
                                    </div>
