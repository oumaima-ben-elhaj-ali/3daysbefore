<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DeplacementEq.aspx.cs" Inherits="PFE.Directeur.Equipements.DeplacementEq" %>
<!doctype html>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">Consulter les locations</strong>
                            </div>
                            <div class="card-body">
                                <div class="row text-center">
                                    ...
                                    <div class="col-md-3 d-flex align-items-center justify-content-center">
                                        <asp:Label ID="Label1" runat="server" Text="Dans le chantier: " CssClass="form-control-label"></asp:Label>
                                        <asp:DropDownList ID="ddlChantier" runat="server" CssClass="form-control"></asp:DropDownList>
                                    </div>
                                    <div class="col-md-3 d-flex align-items-center justify-content-center" >
                                        <asp:Button ID="Consulter" runat="server" Text="Consulter" CssClass="btn btn-outline-success" OnClick="Consulter_Click"/>
                                    </div>
                                </div>
                                <br /><br />
                                <div id="mydiv" runat="server" class="sufee-alert alert with-close alert-secondary alert-dismissible fade show my-margin-lf-rg">
                                <span class="badge badge-pill badge-warning">Info</span> Aucun déplacement correspendant au données entrées!
                                ...
                                <span aria-hidden="true">&times;</span>
                                    ...
                                    <asp:GridView ID="gvSimulation" CssClass="table table-striped table-bordered" runat="server" AutoGenerateColumns="false" AllowPaging="true" OnPageIndexChanging = "OnPaging">
                                        <Columns>
                                               ...
                                               <asp:BoundField DataField="ST_DESEQ" HeaderText ="Designation" />
                                               <asp:BoundField DataField="DT_ENTREE" HeaderText ="Date de location" />
                                        </Columns>
                                    </asp:GridView>
